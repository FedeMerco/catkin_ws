...
get_filename_component(_filename "/home/federico/catkin_ws/src/netft_rdt_driver/srv/String_cmd.srv" NAME_WE)
add_custom_target(_netft_rdt_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "netft_rdt_driver" "/home/federico/catkin_ws/src/netft_rdt_driver/srv/String_cmd.srv" ""
)
...
_generate_srv_cpp(netft_rdt_driver
  "/home/federico/catkin_ws/src/netft_rdt_driver/srv/String_cmd.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/netft_rdt_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/netft_rdt_driver\")")
  # install generated code
  install(
